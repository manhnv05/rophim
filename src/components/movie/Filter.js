                ...
                <div className={`filter-elements ${!showFilter ? "d-none" : ""}`}>
                    ...
                    <div className="fe-row">
                        ...
                        <div className="fe-results">
                            ...
                            {genres.map(item => (
                                <div key={`f-g-${item._id}`} onClick={() => handleUpdateFilterArray('genres', item._id)}
                                     className={`item ${selectedFilter.genres.includes(item._id) ? 'active' : ''}`}>{item.name}</div>
                            ))}
                        </div>
                    </div>
